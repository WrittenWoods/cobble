import { NestedSheet } from "./helpers/interfaces";

// Character sheet in the form of an array of nested NestedBlocks.

export const starterSheetData: NestedSheet = {

  sheetData: [

    {title: 'main page', displayInfo: { displayed: false, displayType: "new panel" } , content: [ // Page 1
    ...
    { title: 'spellbook', displayInfo: { displayed: false, displayType: "new panel" } , content: [ // Page 2
